...
<?php echo $this->Form->create('Scheadule'); ?>
	<fieldset>
		<legend><?php echo __('Edit Scheadule'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Scheadule.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Scheadule.id'))); ?></li>
