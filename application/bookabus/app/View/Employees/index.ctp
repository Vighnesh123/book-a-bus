<div class="employees index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('emp_status'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($employee['Employee']['role']); ?>&nbsp;</td>
		<td><?php echo h($employee['Employee']['date_added']); ?>&nbsp;</td>
		<td><?php echo h($employee['Employee']['emp_status']); ?>&nbsp;</td>
		<td class="actions">
