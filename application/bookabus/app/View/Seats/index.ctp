<div class="seats index">
	...
	<tr>
		<td><?php echo h($seat['Seat']['seat_code']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $seat['Seat']['id']), array(), __('Are you sure you want to delete # %s?', $seat['Seat']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
