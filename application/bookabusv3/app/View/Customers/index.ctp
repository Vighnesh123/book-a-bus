<div class="customers index">
	...
	<tr>
		...
		<td><?php echo h($customer['Customer']['fname']); ?>&nbsp;</td>
		<td><?php echo h($customer['Customer']['lname']); ?>&nbsp;</td>
		<td><?php echo h($customer['Customer']['MI']); ?>&nbsp;</td>
		<td><?php echo h($customer['Customer']['email']); ?>&nbsp;</td>
		<td><?php echo h($customer['Customer']['phone']); ?>&nbsp;</td>
		<td><?php echo h($customer['Customer']['birthday']); ?>&nbsp;</td>
		<td><?php echo h($customer['Customer']['valid']); ?>&nbsp;</td>
		<td><?php echo h($customer['Customer']['register_date']); ?>&nbsp;</td>
